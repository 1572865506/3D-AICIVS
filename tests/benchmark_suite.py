...
def execute_benchmark_case(
    ...
    for c in v2_cargos:
        sid = c.sku_id
        is_elastic = bool(getattr(getattr(c, "quantity", None), "is_elastic", False) or getattr(c, "is_elastic", False))
    ...
    priority_inversion = bool(rigid_req > 0 and rigid_comp_pct < 99.0 and elastic_placed > 0)
